...
import AboutIcon from '/src/static/icons/about.png';
</script>
...
<template>
   <Page class="_about-me">
      ...
      <p>
         Hello, I am Kadir Yazıcı, I was born in 2001 and living in
      ...
      <p></p>
      <div class="_image">
         <img class="_img" src="/src/static/me.png" />
...
._about-me {
   ._image {
      ...
      &::before {
         ...
         width: 45px;
         height: 15px;
         background-color: rgba(rgb(122, 124, 87), 0.3);
         transform: rotate(45deg);
         clip-path: $imageClipPath;
         -webkit-clip-path: $imageClipPath;
      }
